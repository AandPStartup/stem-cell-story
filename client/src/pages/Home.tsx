...
const challenges = {
  fa: [
    ["کنترل تمایز", "باید سلول هدف را به‌طور قابل اعتماد تولید کرد و سلول‌های ناخواسته را به حداقل رساند.", "تغییر کوچک در پیام‌های محیطی می‌تواند مسیر سلول را عوض کند؛ بنابراین کنترل فرآیند ضروری است.", "برای ارزیابی، نشانگرهای هویتی، درصد خلوص و رفتار سلول در چند مرحله بررسی می‌شود؛ یک تصویر زیبا به‌تنهایی کافی نیست."],
    ["ایمنی و رد پیوند", "سیستم ایمنی ممکن است سلول‌های پیوندشده را بیگانه بداند یا سلول‌ها درست کار نکنند.", "سازگاری ایمنی و پایش طولانی‌مدت بخشی از مسیر ارزیابی است.", "منبع سلول، روش آماده‌سازی و وضعیت بدن گیرنده می‌توانند پاسخ ایمنی را تغییر دهند؛ به همین دلیل بقا و عملکرد باید در طول زمان سنجیده شود."],
    ["خطر تومورزایی", "سلول‌های پرتوان باقی‌مانده یا سلول‌های غیرطبیعی می‌توانند خطر ایجاد تومور داشته باشند.", "خالص‌سازی، آزمون‌های دقیق و کنترل کیفیت برای کاهش این خطر لازم‌اند.", "پژوهشگران باید هم جمعیت سلولی را از نظر ژنتیکی و هم رفتار آن را پس از انتقال بررسی کنند؛ کنترل یک مرحله، جایگزین پایش چندمرحله‌ای نیست."],
    ["بقا و ادغام", "سلول‌های منتقل‌شده باید زنده بمانند، با بافت اطراف ارتباط برقرار کنند و وظیفه‌ی درست را انجام دهند.", "رسیدن سلول به بافت، فقط آغاز پرسش است؛ عملکرد پایدار اهمیت دارد.", "محیط اطراف، خون‌رسانی، پیام‌های بافتی و ارتباط سلول با همسایه‌ها تعیین می‌کنند که اثر درمانی کوتاه‌مدت بماند یا به عملکرد واقعی تبدیل شود."],
    ["مقیاس‌پذیری و کیفیت", "تولید باید استریل، قابل تکرار، قابل ردیابی و از یک دسته به دسته‌ی دیگر سازگار باشد.", "آنچه در یک آزمایش کوچک کار می‌کند، لزوماً در مقیاس درمانی پایدار نیست.", "با بزرگ‌شدن فرآیند، تفاوت مواد اولیه، زمان کشت و شرایط دستگاه‌ها می‌تواند نتیجه را تغییر دهد؛ مستندسازی و آزمون آزادسازی برای هر دسته ضروری است."],
    ["شواهد بالینی و اخلاق", "نتیجه‌ی امیدوارکننده‌ی آزمایشگاهی با درمان اثبات‌شده یکی نیست؛ کارآزمایی، رضایت آگاهانه و نظارت لازم است.", "اعتماد علمی با شفافیت، ارزیابی مستقل و پیگیری طولانی‌مدت ساخته می‌شود.", "پرسش اصلی این است که فایده‌ی احتمالی از خطرها بیشتر است یا نه؛ پاسخ باید از داده‌ی انسانی، معیارهای ازپیش‌تعیین‌شده و گزارش شفاف به دست بیاید."],
  ],
  en: [
    ["Controlled differentiation", "Researchers must reliably produce the intended cell type and minimize unwanted cells.", "Small changes in environmental signals can redirect a cell, so control matters.", "Identity markers, purity, and behavior are checked across multiple stages; a convincing image alone is not enough evidence."],
    ["Immunity and rejection", "The immune system may attack transplanted cells, or the cells may not function as intended.", "Immune compatibility and long-term monitoring are part of translation.", "Cell source, preparation method, and the recipient’s biology can change the immune response, so survival and function must be followed over time."],
    ["Tumor risk", "Remaining pluripotent or abnormal cells may create a risk of tumors.", "Purification, careful testing, and quality control are essential.", "Researchers assess both genetic stability and post-transplant behavior; one safety check cannot replace a layered assessment."],
    ["Survival and integration", "Transplanted cells must survive, connect with surrounding tissue, and perform the right function.", "Reaching a tissue is only the beginning; durable function matters.", "Local blood supply, tissue cues, and cell-to-cell contact help determine whether a short-lived effect becomes stable biological function."],
    ["Scale and quality", "Manufacturing must be sterile, reproducible, traceable, and consistent across batches.", "What works in a small experiment may not remain stable at clinical scale.", "As production grows, materials, timing, and equipment can introduce variation; documentation and release testing are needed for every batch."],
    ["Clinical evidence and ethics", "A promising laboratory result is not the same as a proven treatment; trials, consent, and oversight are required.", "Scientific trust is built through transparency, independent review, and follow-up.", "The central question is whether potential benefit outweighs risk; that answer must come from human data, predefined outcomes, and transparent reporting."],
  ],
};
...
export default function Home() {
  ...
  const timelineStageNotes = lang === "fa" ? ["هنوز امکان‌های زیادی باز است؛ سلول منبع را حفظ می‌کند.", "محیط با پیام‌های مولکولی، تماس و ماتریکس مسیر را جهت می‌دهد.", "تغییر بیان ژن‌ها پروتئین‌ها و رفتار آینده را بازتنظیم می‌کند.", "سلول وارد مسیر محدودتری می‌شود و گزینه‌های نزدیک‌تری دارد.", "ساختار و عملکرد سلول با نقش نهایی آن هماهنگ می‌شوند."] : ["Many possibilities remain open; the cell preserves its source state.", "Molecular cues, contact, and matrix signals guide the route.", "Gene-expression changes reset future proteins and behavior.", "The cell enters a narrower route with related options.", "Cell structure and function align with the final role."];
  ...
  return <div id="top" className="site-shell" dir={direction}>
    ...
    <main>
      ...
      <section id="one" className="story-section section-grid">
        <motion.div className="section-intro" {...motionProps}><SectionTag n="01" label={t.question} /><h2>{t.stemTitle}</h2><p className="lead">{t.stemIntro}</p><p>{t.stemBody}</p><div className="stem-snapshot"><div className="snapshot-head"><span>{lang === "fa" ? "داده‌ی کلیدی" : "KEY DATA"}</span><b>{lang === "fa" ? "خوانش سریع" : "QUICK READ"}</b></div><div className="snapshot-grid"><div><span>01</span><div><b>{lang === "fa" ? "منبعِ قابل نوسازی" : "Renewable source"}</b><p>{lang === "fa" ? "خودنوزایی، ذخیره‌ی سلولی را حفظ می‌کند." : "Self-renewal maintains a renewable cell source."}</p></div></div><div><span>02</span><div><b>{lang === "fa" ? "هویتِ قابل تغییر" : "Changeable identity"}</b><p>{lang === "fa" ? "پیام‌ها و ژن‌ها مسیر تخصصی‌شدن را هدایت می‌کنند." : "Signals and genes guide the route toward specialization."}</p></div></div><div><span>03</span><div><b>{lang === "fa" ? "عملکرد، معیار نهایی" : "Function is the test"}</b><p>{lang === "fa" ? "شباهت ظاهری کافی نیست؛ سلول باید درست کار کند." : "Looks are not enough; the cell must perform its role."}</p></div></div></div><div className="snapshot-foot"><i />{lang === "fa" ? "از قابلیت تا عملکرد؛ هر مرحله باید سنجیده شود." : "From potential to function; every step needs evidence."}</div></div><div className="stem-proof"><div className="proof-head"><span>{lang === "fa" ? "از هویت تا عملکرد" : "IDENTITY → FUNCTION"}</span><b>{lang === "fa" ? "سه آزمون پژوهشی" : "THREE RESEARCH CHECKS"}</b></div><div className="proof-track"><div><i>01</i><b>{lang === "fa" ? "هویت" : "Identity"}</b><p>{lang === "fa" ? "آیا نشانگرهای سلولی درست‌اند؟" : "Are the right cell markers present?"}</p></div><div><i>02</i><b>{lang === "fa" ? "خلوص" : "Purity"}</b><p>{lang === "fa" ? "آیا سلول ناخواسته باقی نمانده؟" : "Are unwanted cells minimized?"}</p></div><div><i>03</i><b>{lang === "fa" ? "عملکرد" : "Function"}</b><p>{lang === "fa" ? "آیا سلول کار واقعی خود را انجام می‌دهد؟" : "Does the cell perform its real role?"}</p></div></div><div className="proof-foot"><span />{lang === "fa" ? "ظاهر شبیه، به‌تنهایی مدرک کافی نیست." : "Looking similar is not evidence by itself."}</div></div><div className="stem-maturity"><div className="maturity-head"><span>{lang === "fa" ? "ظاهر یا عملکرد؟" : "LOOKS OR FUNCTION?"}</span><b>{lang === "fa" ? "معیار بلوغ" : "MATURITY CHECK"}</b></div><div className="maturity-meter"><span /><i>{lang === "fa" ? "شباهت" : "RESEMBLANCE"}</i><b>{lang === "fa" ? "بلوغ عملکردی" : "FUNCTIONAL MATURITY"}</b></div><p>{lang === "fa" ? "یک سلول ممکن است در تصویر شبیه سلول هدف به نظر برسد، اما هنوز پاسخ درست به پیام‌ها را ندهد. پژوهشگر باید رفتار، پایداری و توان انجام وظیفه‌ی واقعی را نیز بسنجد." : "A cell may look like its target under a microscope and still fail to respond correctly to signals. Researchers also test behavior, stability, and the ability to perform the real task."}</p><div className="maturity-tags"><span>{lang === "fa" ? "رفتار" : "Behavior"}</span><span>{lang === "fa" ? "پایداری" : "Stability"}</span><span>{lang === "fa" ? "وظیفه" : "Task"}</span></div></div><div className="ability-list"><div><strong>01</strong><div><h3>{t.selfRenew}</h3><p>{t.selfRenewBody}</p></div></div><div><strong>02</strong><div><h3>{t.differentiate}</h3><p>{t.differentiateBody}</p></div></div></div><button className="text-button" onClick={() => setDeep(!deep)}>{deep ? t.simpleMode : t.deepMode}<ChevronDown size={15} className={deep ? "rotate-180" : ""} /></button>{deep && <div className="deep-note">{lang === "fa" ? "تمایز به زمینه وابسته است: پیام‌های مولکولی، تماس با سلول‌های همسایه، ماتریکس بافت و تنظیم بیان ژن‌ها همگی در تعیین سرنوشت سلول نقش دارند." : "Differentiation is context-dependent: molecular signals, neighboring cells, the tissue matrix, and gene regulation all influence cell fate."}</div>}</motion.div>
      ...
      <section id="differentiation" className="timeline-section"><div className="wide-inner"><SectionTag n="01—A" label={lang === "fa" ? "مسیر تمایز" : "The differentiation path"} /><div className="timeline-intro"><div><h2>{lang === "fa" ? "هویت سلول، یک تصمیم لحظه‌ای نیست." : "Cell identity is not a single moment."}</h2><p>{lang === "fa" ? "محیط، پیام‌ها و برنامه‌های ژنی در طول زمان با هم کار می‌کنند تا یک سلول را تخصصی کنند." : "Environment, signals, and gene programs work together over time to specialize a cell."}</p></div><div className="timeline-signal"><span>{lang === "fa" ? "سیگنال زنده" : "LIVE SIGNAL"}</span><b>{timelineDetails[timelineIndex].cue}</b><i /></div></div><div className="timeline"><div className="timeline-line" />{timelineLabels.map((label, i) => <button key={label} className={`timeline-step ${i === timelineIndex ? "selected" : ""}`} onClick={() => setTimelineIndex(i)} aria-pressed={i === timelineIndex}><span>{String(i + 1).padStart(2, "0")}</span><i /><div className="timeline-label"><b>{label}</b><small>{timelineStageNotes[i]}</small></div></button>)}</div><AnimatePresence mode="wait"><motion.div key={timelineIndex + lang} className={`timeline-detail stage-${timelineIndex + 1}`} initial={reduced ? {} : { opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: .28 }}><div className="timeline-detail-index">0{timelineIndex + 1}</div><div><small>{lang === "fa" ? "ایستگاه انتخاب‌شده" : "SELECTED STATION"}</small><h3>{timelineDetails[timelineIndex].title}</h3><p>{timelineDetails[timelineIndex].body}</p></div><button onClick={() => setTimelineIndex((timelineIndex + 1) % timelineLabels.length)}>{lang === "fa" ? "ایستگاه بعدی" : "Next station"}<ArrowUpRight size={15} /></button></motion.div></AnimatePresence><div className="timeline-notes">{(lang === "fa" ? [["سیگنال", "محیط مسیر را جهت می‌دهد."], ["ژن", "بیان ژن هویت تازه را می‌سازد."], ["زمینه", "بافت، عملکرد را تثبیت می‌کند."]] : [["SIGNAL", "Context gives the route a direction."], ["GENE", "Expression builds a new identity."], ["CONTEXT", "Tissue helps stabilize function."]]).map(([label, value], i) => <div key={label} className={`timeline-note note-${i + 1}`}><span>0{i + 1}</span><div><small>{label}</small><b>{value}</b></div><i /></div>)}</div></div></section>

      <section id="two" className="story-section challenges-section"><div className="wide-inner"><motion.div {...motionProps}><SectionTag n="02" label={t.question} /><div className="section-head-row"><div><h2>{t.challengeTitle}</h2><p className="lead">{t.challengeIntro}</p></div><div className="annotation">{lang === "fa" ? "۶ دروازه‌ی مهم" : "06 critical gates"}<span>↓</span></div></div></motion.div><div className="challenge-layout"><div className="challenge-list">{challenges[lang].map((c, i) => <motion.button {...motionProps} transition={{ ...(motionProps.transition as object), delay: i * 0.04 }} key={c[0]} className={`challenge-card ${openChallenge === i ? "open" : ""}`} onClick={() => setOpenChallenge(openChallenge === i ? null : i)}><span className="challenge-number">0{i + 1}</span><span className="challenge-copy"><b>{c[0]}</b><span>{c[1]}</span>{openChallenge === i && <><em>{c[2]}</em><small className="challenge-evidence">{c[3]}</small></>}</span><ChevronDown size={18} /></motion.button>)}</div><div className="challenge-visual"><img src={ASSETS.tissue} alt={lang === "fa" ? "نمایش هنری از محیط بافتی در پزشکی بازساختی" : "Artistic visualization of a tissue environment in regenerative medicine"} /><div className="plate-callout callout-a"><i />{lang === "fa" ? "محیط بافتی" : "Tissue context"}</div><div className="plate-callout callout-b"><i />{lang === "fa" ? "ادغام سلولی" : "Cell integration"}</div><div className="plate-caption"><span>PLATE 02</span><b>{lang === "fa" ? "بقا، رسانش، عملکرد" : "Survival, delivery, function"}</b></div><div className="challenge-gate" dir={direction}><div className="challenge-gate-head"><span>{lang === "fa" ? "دروازه‌ی ترجمه" : "TRANSLATION GATE"}</span><b>{openChallenge !== null ? challenges[lang][openChallenge][0] : (lang === "fa" ? "یک دروازه را انتخاب کنید" : "Select a gate")}</b></div><div className="gate-mini-track">{challenges[lang].slice(0, 3).map((c, i) => <button key={c[0]} className={openChallenge === i ? "active" : ""} onClick={() => setOpenChallenge(i)}><i>0{i + 1}</i><span>{c[0]}</span></button>)}</div><p>{openChallenge !== null ? challenges[lang][openChallenge][3] : (lang === "fa" ? "هر دروازه، یک پرسش قابل‌سنجش میان آزمایشگاه و درمان است." : "Each gate is a measurable question between laboratory promise and treatment.")}</p></div></div></div><div className="evidence-strip"><div className="evidence-heading"><div><span className="evidence-kicker">{lang === "fa" ? "مسیر ترجمه" : "TRANSLATION PATH"}</span><h3>{t.gapTitle}</h3></div><p>{lang === "fa" ? "هر قدم، شواهد بیشتری می‌خواهد؛ از یک ایده‌ی امیدوارکننده تا درمانی که بتوان به آن اعتماد کرد." : "Every step needs stronger evidence—from a promising idea to a treatment people can trust."}</p></div><div className="evidence-track"><div className="evidence-fill" />{(lang === "fa" ? [["01", t.lab, "ایده و امکان"], ["02", t.preclinical, "آزمون و ایمنی"], ["03", t.validated, "شواهد انسانی"]] : [["01", t.lab, "Idea and possibility"], ["02", t.preclinical, "Testing and safety"], ["03", t.validated, "Human evidence"]]).map(([n, label, note], i) => <div key={label} className={`evidence-stage stage-${i + 1}`}><span>{n}</span><i /><div><b>{label}</b><small>{note}</small></div></div>)}</div><div className="evidence-foot"><span>{lang === "fa" ? "فاصله با یک تصویر زیبا پر نمی‌شود" : "A beautiful image cannot close the gap"}</span><b>{lang === "fa" ? "با داده، ایمنی و پیگیری پر می‌شود." : "Data, safety, and follow-up can."}</b></div></div></div></section>
